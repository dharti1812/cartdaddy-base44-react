...
import { Package, MapPin, Clock, RefreshCw, Eye } from "lucide-react";
...
const statusConfig = {
  ...
  offered: { label: "Offered", color: "bg-blue-100 text-blue-800 border-blue-200" },
  ...
  no_provider_found: { label: "No Provider", color: "bg-gray-100 text-gray-800 border-gray-200" }
};

export default function RecentOrders({ orders, loading, onRefresh }) {
