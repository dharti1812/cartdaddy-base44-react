  ...
  useEffect(() => {
    if (retailerProfile?.bank_details) {
      setBankData({
        ...
        ifsc_code: retailerProfile.bank_details.ifsc || "",
        bank_name: retailerProfile.bank_details.bank_name || "",
        account_holder_name:
          retailerProfile.bank_details.account_holder_name || "",
      });
    }
  }, [retailerProfile]);
        ...
        <Tabs value={activeSettingsTab} onValueChange={setActiveSettingsTab}>
          ...
          <TabsContent value="security">
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="current_password">Confirm New Password</Label>
                <Input
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setBankData({
                        account_number:
                          retailerProfile?.bank_details?.account_number || "",
                        ifsc_code: retailerProfile?.bank_details?.ifsc || "",
                        bank_name:
                          retailerProfile?.bank_details?.bank_name || "",
                      });
                    }}
                  >
                    Cancel
