// File: ../components/retailer/dBProfileSettings.jsx
...
export default function DeliveryBoyProfileSettings({ dBProfile, onUpdateProfile }) {
    ...
    const [bankData, setBankData] = useState({
        account_number: dBProfile?.bank_details?.account_number || '',
        ifsc_code: dBProfile?.bank_details?.ifsc_code || '',
        bank_name: dBProfile?.bank_details?.bank_name || '',
    });
    ...
    return (
        <Card className="shadow-lg border-none">
                    ...
                    <TabsContent value="general">
                        <form onSubmit={handleUpdateProfile} className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="name">Delivery Boy Name</Label>
                                <Input
                                    id="name"
                                    name="name"
           ...
           to the dBProfileSettings component logic (similar to how password change was implemented). */}
