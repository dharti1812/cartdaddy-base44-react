        ...
        <div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="font-medium text-gray-700">Assign Seller</p>
                <p className="text-gray-600">
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="font-medium text-gray-700">Assign Delivery Boy</p>
                <p className="text-gray-600">
                  {order.assign_delivery_boy_name ?? "Not Assigned"}
                </p>
              </div>
            </div>
          </div>
